...
// import footerBg from "../../assets/background/footerBackground.jpg";
    ...
    <div className="relative mt-16">
      ...
      <div className=" max-w-screen-xl mx-auto">
        <div className="absolute top-5 px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            ...
            <div className="grid grid-cols-2 text-center  gap-5 row-gap-8 lg:col-span-4 sm:text-center  md:grid-cols-4">
              ...
              <div className="col-span-4 md:max-w-md lg:col-span-2">
                ...
                <form className="flex flex-col mt-4 md:flex-row">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none bg-brand transform hover:scale-105 ease-in-out duration-300"
                  >
                    Subscribe
                  </button>
                </form>
          ...
          <div className="flex justify-center pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
