import doctor from "../../assets/team/team (3).jpg";
import detailsImg from "../../assets/service/service (2).jpg";
        ...
        <main className="mt-10">
          <div className="mb-4 md:mb-0 w-full mx-auto relative">
            <div className="px-4 lg:px-0">
              <h2 className="text-4xl font-bold text-brand leading-tight">
                Having overw eight and depression can
              </h2>
              <a
                href="#"
                className="py-2 text-gray-400 inline-flex items-center justify-center mb-2"
              >
                Manual Nair
              </a>
            </div>

            <img src={detailsImg} className="w-full" />
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:space-x-12">
            <div className="px-4 lg:px-0 mt-12 text-gray-400 text-lg leading-relaxed w-full lg:w-3/4">
              ...
              <div className="border-l-4 border-brand pl-4 mb-6 italic rounded">
              ...
              <h2 className="text-2xl text-brand font-semibold mb-4 mt-4">
            ...
            <div className="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
              <div className="p-4 border-t border-b md:border md:rounded">
                ...
                <button className="px-2 py-1 text-gray-100 bg-brand flex w-full items-center justify-center rounded">
                  Follow
